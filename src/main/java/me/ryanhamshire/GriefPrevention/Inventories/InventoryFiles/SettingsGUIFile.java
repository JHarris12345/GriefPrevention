    ...
    public static void setup() {
        ...
        if (!file.exists()) {
            ...
            try {
                ...
                customFile.set("Settings.NATURAL_MONSTER_SPAWNS.iCoins", 100);
                ...
                customFile.set("Settings.NATURAL_ANIMAL_SPAWNS.iCoins", 100);
                ...
                customFile.set("Settings.LEAF_DECAY.iCoins", 100);
                ...
                customFile.set("Settings.ICE_FORM.iCoins", 100);
                ...
                customFile.set("Settings.ICE_MELT.iCoins", 100);
                ...
                customFile.set("Settings.SNOW_FORM.iCoins", 100);
                ...
                customFile.set("Settings.SNOW_MELT.iCoins", 100);
                ...
                customFile.set("Settings.GRASS_SPREAD.iCoins", 100);
                ...
                customFile.set("Settings.VINE_GROWTH.iCoins", 100);
                ...
                customFile.set("Settings.FORCED_WEATHER.iCoins", 100);
                ...
                customFile.set("Settings.FORCED_TIME.iCoins", 100);
                ...
                customFile.set("Settings.COPPER_WEATHERING.iCoins", 100);
                ...
                customFile.set("Settings.CORAL_DRY.iCoins", 100);
                ...
                customFile.set("Settings.CROP_GROWTH.iCoins", 100);
