    ...
    public static void setup() {
        ...
        if (!file.exists()) {
            ...
            try {
                ...
                customFile.set("Settings.NATURAL_MONSTER_SPAWNS.iCoins", 50);
                ...
                customFile.set("Settings.NATURAL_ANIMAL_SPAWNS.iCoins", 50);
                ...
                customFile.set("Settings.LEAF_DECAY.iCoins", 50);
                ...
                customFile.set("Settings.ICE_FORM.iCoins", 50);
                ...
                customFile.set("Settings.ICE_MELT.iCoins", 50);
                ...
                customFile.set("Settings.SNOW_FORM.iCoins", 50);
                ...
                customFile.set("Settings.SNOW_MELT.iCoins", 50);
                ...
                customFile.set("Settings.GRASS_SPREAD.iCoins", 50);
                ...
                customFile.set("Settings.VINE_GROWTH.iCoins", 50);
                ...
                customFile.set("Settings.FORCED_WEATHER.iCoins", 50);
                ...
                customFile.set("Settings.FORCED_TIME.iCoins", 50);
                ...
                customFile.set("Settings.COPPER_WEATHERING.iCoins", 50);
                ...
                customFile.set("Settings.CORAL_DRY.iCoins", 50);
                ...
                customFile.set("Settings.CROP_GROWTH.iCoins", 50);
